            ...
            >
              ...
              <div className="col-span-1 md:col-span-2 flex items-center gap-3 font-semibold">
                ...
                <div className="truncate">
                  ...
                  <p className="md:hidden text-[10px] text-gray-400 font-normal">{formatDate(rec.createdAt)} • {formatTime(rec.duration)}</p>
                </div>
              </div>

              {/* Date */}
              <div className='hidden md:block text-sm text-[#1F2937]'>{formatDate(rec.createdAt)}</div>
