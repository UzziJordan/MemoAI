    ...
    return (
        ...
        >
            ...
            <div className="flex bg-[#F3F4F6] rounded-xl p-1 h-12 text-[10px] md:text-[14px] font-bold">
                <button className="bg-white rounded-lg px-15 md:px-18 py-1 shadow-sm text-[#111827]">
                    Sign In
                </button>
                <Link to="/SignupPage" className="flex-1">
                    <motion.button 
                        whileHover={{ color: "#2828FA" }}
                        className="w-full h-full py-1.5 text-[#9CA3AF]"
                    >
                        Create Account
                    </motion.button>
                </Link>
            ...
            <form onSubmit={handleSubmit} className="mt-8">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="button"
                    className="w-full border-[#E5E7EB] border-2 text-[14px] font-bold text-[#374151] rounded-xl py-3.5 flex items-center justify-center gap-3 mb-8 transition-colors"
                >
                ...
                <div className='flex justify-between items-center text-center opacity-50'>
                    ...
                    <div className="text-[11px] font-bold text-[#D1D5DB] px-4 uppercase tracking-widest">
                        or email
                    </div>
                    <div className='h-0.5 flex-1 bg-[#E5E7EB]'></div>
                </div>
                ...
                {/* Email Input */}
                <div className="mt-8">
                    <label className="font-bold text-[12px] text-[#374151] uppercase tracking-widest">Email address</label>
                ...
                <div className="mt-6">
                    <div className="flex justify-between items-center">
                        <label className="font-bold text-[12px] text-[#374151] uppercase tracking-widest">Password</label>
                        <Link to="/ForgotPassword" title="Reset password" data-testid="forgot-password-link" className="text-[#2828FA] text-[12px] font-bold hover:underline">
                            Forgot?
                        </Link>
                    </div>
                ...
                <div className="flex items-center gap-3 mt-6">
                    <input type="checkbox" className="w-5 h-5 rounded-md border-2 border-gray-200 accent-[#2828FA] cursor-pointer" />
                    <p className="text-sm font-bold text-gray-500">Keep me signed in</p>
                </div>
                ...
                <motion.button
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full mt-8 py-4 rounded-xl text-white font-bold bg-[#2828FA] shadow-xl shadow-blue-100 hover:bg-[#1D1DFA] transition-all disabled:opacity-50"
                >
            ...
            <div className="flex justify-center gap-6 mt-10 text-[10px] font-bold text-[#D1D5DB] uppercase tracking-tighter">
