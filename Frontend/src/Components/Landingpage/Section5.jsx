...
const Section5 = () => {
    // --- RENDER ---
    return (
        <div className='bg-[#EFF2F9] dark:bg-gray-950 mt-18 w-full text-geist dark:text-gray-100 h-auto overflow-hidden pb-16 lg:pb-0 transition-colors duration-300'>
            {/* MAIN CONTAINER */}
            <div className='flex flex-col-reverse justify-center items-center align-middle py-12 gap-10 lg:gap-20 md:pt-5 lg:pt-10 lg:flex-row'>
                ...
                <div className='w-full max-w-112.5 px-6 text-center lg:mx-0 lg:pt-3 lg:text-left '>
                    ...
                    <motion.div 
                        ...
                        className='lg:pt-4'
                    >
                        <h1 className='font-extrabold text-[32px] md:text-[40px] leading-tight text-gray-800 dark:text-gray-100 lg:mx-0 flex flex-wrap justify-center lg:justify-start gap-2'>
                            Searchable <span className='bg-[#2828FA] text-white px-3 rounded-xl transform -rotate-1'>Transcripts</span>
                        </h1>
                        <p className='text-[16px] text-[#6B7280] dark:text-gray-400 mt-6 font-medium leading-relaxed'>Every word is transcribed and indexed. Search across all your recordings by keyword, date, or speaker and jump straight to the exact moment that matters.</p>
                    </motion.div>
                    ...
                    <div className="flex flex-col gap-4 mt-8 items-start max-w-sm mx-auto lg:ml-0 lg:max-w-none">
                        {[
                            ...
                            <motion.p 
                                ...
                                className="flex gap-4 text-[13px] font-bold text-gray-700 dark:text-gray-300 cursor-default transition-colors"
                            >
                                <span className="flex items-center justify-center w-6 h-6 border-[3px] border-gray-800 dark:border-gray-400 rounded-lg shrink-0">
