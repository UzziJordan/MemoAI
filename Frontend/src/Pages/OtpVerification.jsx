        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
            ...
            >
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 text-[#2828FA] rounded-full mb-6">
                        <FaLock size={24} />
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-8">
                        ...
                        <input
                            ...
                            placeholder="000000"
                            className="w-full text-center text-3xl tracking-[1em] font-bold border-2 border-gray-100 bg-gray-50 rounded-2xl py-4 focus:outline-none focus:border-blue-400 focus:bg-white transition-all"
                            maxLength={6}
                        />
                    </div>
                    ...
                    <button
                        ...
                        className="w-full py-4 rounded-2xl text-white font-bold bg-[#2828FA] shadow-xl shadow-blue-100 hover:bg-[#1D1DFA] transition-all disabled:opacity-50 mb-6"
                    >
                ...
                <div className="text-center">
                    ...
                    <button
                        ...
                        disabled={resending}
                        className="text-[#2828FA] font-bold hover:underline disabled:opacity-50"
                    >
